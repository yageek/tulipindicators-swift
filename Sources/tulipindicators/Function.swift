...
public func dpo(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "dpo", inputs: inputs, options: [Double(n)])
}
...
public func dx<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "dx", inputs: HLC(inputs), options: [Double(n)])
}
...
public func edecay(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "edecay", inputs: inputs, options: [Double(n)])
}

/// Ease of Movement
/// - Parameter inputs: An array of `Quotable` elements
public func emv<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "emv", inputs: HLV(inputs), options: [])
}

/// Vector Exponential
/// - Parameter inputs: The inputs
public func exp(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "exp", inputs: inputs, options: [])
}
...
public func fisher<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, FisherResult) {
    let (begin, outputs) = Bindings.shared.call_indicator(name: "fisher", inputs: HL(inputs), options: [Double(n)])
    let count = inputs.count - begin
    let splits = stride(from: 0, to: 2*count, by: count).map { Array(outputs[$0..<$0+count])}
...
public func floor(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "floor", inputs: inputs, options: [])
}
...
public func fosc(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "fosc", inputs: inputs, options: [Double(n)])
}
...
public func hma(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "hma", inputs: inputs, options: [Double(n)])
}
...
public func kvo<T: Quotable>(_ inputs: [T], short: Int, long: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "kvo", inputs: HLCV(inputs), options: [Double(short), Double(long)])
}
...
public func lag(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "lag", inputs: inputs, options: [Double(n)])
}
...
public func linreg(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "linreg", inputs: inputs, options: [Double(n)])
}
...
public func linregintercept(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "linregintercept", inputs: inputs, options: [Double(n)])
}
...
public func linregslope(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "linregslope", inputs: inputs, options: [Double(n)])
}

/// Vector Natural Log
/// - Parameter inputs: The inputs
public func ln(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "ln", inputs: inputs, options: [])
}

/// Vector Base-10 Log
/// - Parameter inputs: The inputs
public func log10(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "log10", inputs: inputs, options: [])
}
...
public func macd(_ inputs: [Double], short: Int, long: Int, signal: Int) -> (Int, MACDResult) {
    let (beginIdx, outputs) = Bindings.shared.call_indicator(name: "macd", inputs: inputs, options: [Double(short), Double(long), Double(signal)])
    let count = inputs.count - beginIdx
...
public func marketfi<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "marketfi", inputs: HLV(inputs), options: [])
}

/// Mass Index
/// - Parameter inputs: An array of `Quotable` elements.
public func mass<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "mass", inputs: HL(inputs), options: [Double(n)])
}

/// Maximum In Period
/// - Parameter inputs: An array of `Quotable` elements.
public func max(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "max", inputs: inputs, options: [Double(n)])
}

/// Mean Deviation Over Period
/// - Parameter inputs: An array of `Quotable` elements.
public func md(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "md", inputs: inputs, options: [Double(n)])
}

/// Median Price
/// - Parameter inputs: An array of `Quotable` elements.
public func medprice<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "medprice", inputs: HLV(inputs), options: [])
}

/// Money Flow Index
/// - Parameter inputs: An array of `Quotable` elements.
public func mfi<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "mfi", inputs: HLCV(inputs), options: [Double(n)])
}

/// Momentum
/// - Parameter inputs: An array of `Quotable` elements.
public func mom(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "mom", inputs: inputs, options: [Double(n)])
}
...
public func msw(_ inputs: [Double], period n: Int) -> (Int, MSWResult) {
    let (beginIdx, outputs) = Bindings.shared.call_indicator(name: "msw", inputs: inputs, options: [Double(n)])
    let count = inputs.count - beginIdx
    let splits = stride(from: 0, to: 2*count, by: count).map { Array(outputs[$0..<$0+count])}
...
public func mul(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "mul", inputs: inputs, options: [])
}

/// Normalized Average True Range
/// - Parameter inputs: An array of `Quotable` elements.
public func natr<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "natr", inputs: HLC(inputs), options: [Double(n)])
}

/// Normalized Average True Range
/// - Parameter inputs: An array of `Quotable` elements.
public func nvi<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "natr", inputs: CV(inputs), options: [Double(n)])
}

/// On Balance Volume
/// - Parameter inputs: An array of `Quotable` elements.
public func obv<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "obv", inputs: CV(inputs), options: [])
}

/// Percentage Price Oscillator
/// - Parameter inputs: The inputs
public func ppo(_ inputs: [Double], short: Int, long: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "ppo", inputs: inputs, options: [Double(short), Double(long)])
}
...
public func psar<T: Quotable>(_ inputs: [T], acceleration: Double, accelerationMax: Double) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "psar", inputs: HL(inputs), options: [acceleration, accelerationMax])
}

/// Positive Volume Index
/// - Parameter inputs: An array of `Quotable` elements.
public func pvi<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "pvi", inputs: CV(inputs), options: [])
}
...
public func qstick<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "qstick", inputs: OC(inputs), options: [Double(n)])
}

/// Rate of Change
/// - Parameter inputs: The input values
public func roc(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "roc", inputs: inputs, options: [Double(n)])
}

/// Rate of Change Ratio
/// - Parameter inputs: The input values
public func rocr(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "rocr", inputs: inputs, options: [Double(n)])
}

/// Vector Round
/// - Parameter inputs: The inputs
public func round(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "round", inputs: inputs, options: [])
}

/// Relative Strength Index
/// - Parameter inputs: The input values
public func rsi(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "rsi", inputs: inputs, options: [Double(n)])
}

/// Vector Sine
/// - Parameter inputs: The inputs
public func sin(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "sin", inputs: inputs, options: [])
}

/// Vector Hyperbolic Sine
/// - Parameter inputs: The inputs
public func sinh(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "sinh", inputs: inputs, options: [])
}

/// Vector Sqrt
/// - Parameter inputs: The inputs
public func sqrt(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "sqrt", inputs: inputs, options: [])
}

/// Standard Deviation Over Period
/// - Parameter inputs: The input values
public func stddev(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "stddev", inputs: inputs, options: [Double(n)])
}

/// Standard Error Over Period
/// - Parameter inputs: The input values
public func stderr(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "stderr", inputs: inputs, options: [Double(n)])
}
...
public func stoch<T: Quotable>(_ inputs: [T], kPeriod: Int, kSlowingPeriod: Int, dPeriod: Int) -> (Int, StochResult) {
    let (beginIdx, outputs) = Bindings.shared.call_indicator(name: "stock", inputs: HLC(inputs), options: [Double(kPeriod), Double(kSlowingPeriod), Double(dPeriod)])
    let count = inputs.count - beginIdx
    let splits = stride(from: 0, to: 2*count, by: count).map { Array(outputs[$0..<$0+count])}
...
public func stochrsi(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "stochrsi", inputs: inputs, options: [Double(n)])
}

/// Vector Substraction
/// - Parameter inputs: The inputs
public func sub(a: [Double], b: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "sub", inputs: a + b, options: [])
}

/// Sum Over Period
/// - Parameter inputs: An array of `Quotable` elements.
public func sum(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "sum", inputs: inputs, options: [Double(n)])
}

/// Vector Tangent
/// - Parameter inputs: The inputs
public func tan(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "tan", inputs: inputs, options: [])
}

/// Vector Hyperbolic Tangent
/// - Parameter inputs: The inputs
public func tanh(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "tanh", inputs: inputs, options: [])
}

/// Vector Degree Conversion
/// - Parameter inputs: The inputs
public func todeg(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "todeg", inputs: inputs, options: [])
}

/// Vector Radian Conversion
/// - Parameter inputs: The inputs
public func torad(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "torad", inputs: inputs, options: [])
}

/// True Range
/// - Parameter inputs: An array of `Quotable` elements
public func tr<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "tr", inputs: HLC(inputs), options: [])
}

/// Trix
/// - Parameter inputs: An array of `Quotable` elements.
public func trix(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "trix", inputs: inputs, options: [Double(n)])
}

/// Vector Truncate
/// - Parameter inputs: The inputs
public func trunc(_ inputs: [Double]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "trunc", inputs: inputs, options: [])
}

/// Time Series Forecast
/// - Parameter inputs: An array of `Quotable` elements.
public func tsf(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "tsf", inputs: inputs, options: [Double(n)])
}

/// Typical Price
/// - Parameter inputs: An array of `Quotable` elements
public func typprice<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "typprice", inputs: HLC(inputs), options: [])
}
...
public func ultosc<T: Quotable>(_ inputs: [T], short: Int, medium: Int, long: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "ultosc", inputs: HLC(inputs), options: [Double(short), Double(medium), Double(long)])
}

/// Variance Over Period
/// - Parameter inputs: The input values
public func variance(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "var", inputs: inputs, options: [Double(n)])
}

/// Vertical Horizontal Filter
/// - Parameter inputs: The input values
public func vhf(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "vhf", inputs: inputs, options: [Double(n)])
}
...
public func vidya(_ inputs: [Double], short: Int, long: Int, alpha: Double) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "vidya", inputs: inputs, options: [Double(short), Double(long), alpha])
}

/// Annualized Historical Volatility
/// - Parameter inputs: The input values
public func volatility(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "volatility", inputs: inputs, options: [Double(n)])
}
...
public func vosc<T: Quotable>(_ inputs: [T], short: Int, long: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "vosc", inputs: inputs.map { $0.volume }, options: [Double(short), Double(long)])
}
...
public func vwma<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "vwma", inputs: CV(inputs), options: [Double(n)])
}

/// Williams Accumulation/Distribution
/// - Parameter inputs: An array of `Quotable` elements
public func wad<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "wad", inputs: HLC(inputs), options: [])
}

/// Weighted Close Price
/// - Parameter inputs: An array of `Quotable` elements
public func wcprice<T: Quotable>(_ inputs: [T]) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "wcprice", inputs: HLC(inputs), options: [])
}

/// Wilders Smoothing
/// - Parameter inputs: The input values
public func wilders(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "wilders", inputs: inputs, options: [Double(n)])
}
...
public func willr<T: Quotable>(_ inputs: [T], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "willr", inputs: HLC(inputs), options: [Double(n)])
}
...
public func zlema(_ inputs: [Double], period n: Int) -> (Int, [Double]) {
    return Bindings.shared.call_indicator(name: "zlema", inputs: inputs, options: [Double(n)])
}
